...
from agent_builder.agent_builder import AgentBuilder, AgentSpecification
...
class AgentBuilderUI:
    ...
    def __init__(self):
        ...
        self.agents_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'agents')
